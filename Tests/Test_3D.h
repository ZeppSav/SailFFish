...
void Test_Dirichlet_3D(int NX, int NY, int NZ, bool ExportVTI = false)
{
    ...
    cout << "Trial Calculation: Solution of the 3D Poisson equation with Dirichlet boundary conditions." << endl;
    cout << std::scientific;
...
void Test_Neumann_3D(int NX, int NY, int NZ, bool ExportVTI = false)
{
    ...
    cout << "Trial Calculation: Solution of the 3D Poisson equation with Neumann boundary conditions." << endl;
    cout << std::scientific;
    cout << "The grid was resolved with [" << NX <<","<< NY <<","<< NZ <<"] cells." << endl;
    cout << "E_inf Error =" csp std::scientific << E_Inf(Output,Solution) << endl;
    cout << std::fixed << std::setprecision(1);
...
void Test_Periodic_3D(int NX, int NY, int NZ, bool ExportVTI = false)
{
    ...
    cout << "Trial Calculation: Solution of the 3D Poisson equation with periodic boundary conditions." << endl;
    cout << std::scientific;
    cout << "The grid was resolved with [" << NX <<","<< NY <<","<< NZ <<"] cells." << endl;
    cout << "E_inf Error =" csp std::scientific << E_Inf(Output,Solution) << endl;
    cout << std::fixed << std::setprecision(1);
...
//                Solution.push_back( Sol[2]);   // Z Solution Field (Phi)
    ...
    cout << "Trial Calculation: Solution of the unbounded 3D Poisson equation." << endl;
    cout << std::scientific;
    cout << "The grid was resolved with [" << NX <<" , "<< NY <<" , "<< NZ <<"] cells. " << endl;
    cout << "E_inf Error =" csp std::scientific << Error << endl;
    cout << std::fixed << std::setprecision(1);
    cout << "Execution Time:" <<  endl;
    cout << "Solver setup "     << std::setw(10) << t2 csp "ms. [" << 100.0*t2/tTot << " %]" << endl;
    cout << "Input spec.  "     << std::setw(10) << t3 csp "ms. [" << 100.0*t3/tTot << " %]" << endl;
